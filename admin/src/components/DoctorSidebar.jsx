...
const DoctorSidebar = () => {
  ...
  const links = [
    { path: '/doctor-dashboard', label: 'Dashboard', icon: <LayoutDashboard className="w-5 h-5" /> },
    { path: '/doctor-appointments', label: 'Appointments', icon: <CalendarCheck className="w-5 h-5" /> },
    { path: '/doctor-profile', label: 'Profile', icon: <UserPlus className="w-5 h-5" /> },
  ];
