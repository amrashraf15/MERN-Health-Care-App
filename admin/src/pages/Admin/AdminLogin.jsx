...
const AdminLogin = () => {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center my-5 text-base-content bg-base-200'>
        <div className='max-w-md w-full bg-base-100 rounded-2xl shadow-xl overflow-hidden'>
            <div className='p-8'>
                <h2 className='text-3xl font-bold mb-6  text-center'><span className='text-primary'>Admin{' '}</span>Login</h2>
